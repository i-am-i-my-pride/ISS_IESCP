    				...
    				importData: function() {
    					issapi.importData({
	    					...
	    					multipart_params: { // 附加参数
	    						...
	    						cols: "CUserName,CMobile,CCertfCls,CCertfCde,TApptDate,CHospitalName,CDeptName,TUsedTm,TCancelDate,COrderStatus,CDesc,CCancelReason",
	            				titles: "就诊人姓名,就诊人手机号,证件类型,证件号码,预约住院时间,医院名称,科室名称,使用时间,取消时间,预约类型,备注,取消原因"
	    					},
